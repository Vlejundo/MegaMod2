...
("ccp_generate_skill_set",
	[
		...
		(try_begin),
			...
			# Armor - defaults to cloth 						#F&B return
			(try_begin),
				(eq, ":armor", 1),
				(ge, ":strength", 3),
			...
			(try_begin),
				...
				(display_message, "@DEBUG (CCP): The player has been given a smithy in the town of {s31}."),
			(try_end),
			...
			(try_begin),
				...
				(str_store_party_name, s31, "$current_town"),
				(assign, reg31, ":lands"),
				(display_message, "@DEBUG (CCP): The player has been given {reg31} acres of land in the town of {s31}."),
			(try_end),
