...
game_menus = [
 (
	...
	#	# This was done to prevent Floris 2.52 from breaking save games.		#F&B disabled because we set the info elsewhere, in order to make it compatible with Dynamic World
#		(try_for_range, ":town_no", towns_begin, towns_end),
	...
	#	(try_end)
	   # (try_for_range, ":town_no", towns_begin, towns_end),					#F&B reanbled random shit
	#		(store_random_in_range, ":offset", 1, 23),
#	#		(store_add, ":cur_object_no", "scn_town_1_arena", ":offset"),
	#		(party_set_slot, ":town_no", slot_town_arena, ":cur_object_no"),
	#		(store_add, ":cur_object_no", "scn_town_1_arena_alternate", ":offset"),
	#		(party_set_slot, ":town_no", slot_town_arena_alternate, ":cur_object_no"),
