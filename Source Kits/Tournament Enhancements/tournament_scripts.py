...
# Input: arg1 = troop
  ("tpe_equip_troop",
    [	
		...
		(party_get_slot, ":city_settings", "$current_town", slot_town_alternate_arena_no), 		#F&B injected
  ...
  ("tpe_set_items_for_tournament",
    [
		...
		(try_begin),
			...
			(party_get_slot, ":city_offset", "$current_town", slot_town_alternate_arena_no), 		#F&B injected
...
("tdp_update_slider",
		[
			...
			#(store_sub, ":town_slot_offset", "$tournament_town", towns_begin),
			(party_get_slot, ":town_slot_offset", "$tournament_town", slot_town_alternate_arena_no), 		#F&B injected
			(val_mul, ":town_slot_offset", 10),
...
("tdp_update_menu_selection",
		[
			...
			(party_get_slot, ":appearance_slot", "$tournament_town", slot_town_alternate_arena_no), 		#F&B injected
  ...
  ("tpe_initialize_default_weapons",
    [
		(try_for_range, ":center_no", towns_begin, towns_end),
			...
			(party_get_slot, ":slot_base", ":center_no", slot_town_alternate_arena_no), 		#F&B injected
...
# Output: none
  ("tpe_determine_real_chance",
    [
		...
		(party_get_slot, ":city_offset", "$tournament_town", slot_town_alternate_arena_no), 		#F&B injected
