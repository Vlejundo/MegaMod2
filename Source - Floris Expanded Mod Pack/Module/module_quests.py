...
# Note : This is defined as the first village elder quest in module_constants.py:
 ...
 #F&B begin rebuild quest
 ("rebuild", "Construction of {s1}", qf_random_quest,
  "{!} The elder of the village of {s3} informs you, that you need to bring the following to {s1}. ^10 sets of tools^10 woolen cloth^25k to pay for expenses^Provide a guard of at least 30 men"
  ),

 #F&B end rebuild quest
