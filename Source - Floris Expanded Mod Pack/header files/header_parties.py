...
#F&B Fix! these seem to cause string error
pf_town 					 = pf_label_large|pf_always_visible|pf_hide_defenders|pf_show_faction|pf_is_static
pf_castle 					 = pf_label_medium|pf_always_visible|pf_hide_defenders|pf_show_faction|pf_is_static
pf_village					 = (pf_label_large, 0|pf_label_small|pf_always_visible|pf_hide_defenders, -1|pf_show_faction, 0|pf_is_static)
